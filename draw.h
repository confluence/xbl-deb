...
extern void drawback(struct opt *opt,struct x *x,struct draw *draw,
                        struct bloc *world,struct transfo *tworld);
extern void drawrealback(struct x *x,
                        struct bloc *world,struct transfo *tworld,
                        struct viewtransfo *view,Drawable d,struct opt *opt);
extern void updatescreen(struct opt *opt,struct x *x,struct point *min,
				struct point *max) ;
