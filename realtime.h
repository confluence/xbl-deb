...
*/
#define OPTIMUM_DISPLAY_TIME 0.01
#define BETWEEN 80 /* Number of images for a transformation of moving bloc */
...
extern void inittime(struct realtime *r,int waitone) ;
extern void nextframe(struct bl *bl,struct realtime *r) ;
extern void microsleep(int i) ;
