/*
    ...
    Copyright (C) 1992,1993,1994,1997  Thierry EXCOFFIER
...
struct x
	...
	char codes[256] ; /* Keycode du clavier numerique + curseur */
	} ;

extern void MyXParseGeometry(Display *d,int screen,char* c,  int *x,int *y,
